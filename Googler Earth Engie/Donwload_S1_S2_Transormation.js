...
var endDate = '2023-03-07' // last day of the composite
...
var exportArea = ee.Geometry.Point([-72.0897246457908,2.929798551312425]).buffer(4000).bounds();
...
function calcLIA(image) {
  ...
  // Podemos usar el gradiente de la banda "Angulo" de la imagen S1 para derivar el angulo azimimuth.
  ...
  // Aqui derivamos la pendiente y el aspecto del terreno
  ...
  // Y luego la proyección de la pendiente
  ...
  // Finalmente el ángulo de incidencia local
...
// Transforme el VV y HV para una mejor visualización de la cobertura del suelo
...
Export.image.toDrive({
  image: S1_export,
  description: 'Mapiripan_Casanare_Sentinel-1_composite_VV_VH',
  scale: 10,
  region: exportArea,
  maxPixels:527496940,
  folder:'Datos'
...
Export.image.toDrive({
  ...
  description: 'Mapiripan_Casanare_Sentinel-2_composite_B4',
  scale: 10,
  region: exportArea,
  maxPixels:527496940,
  folder: 'Datos'
